...
export function BentoGrid() {
  const features = [
    {
      title: "AI-Driven Visual Analysis",
      description:
        "Unlock deeper insights with advanced AI tools designed to process and interpret visual data seamlessly.",
    ...
    },
    {
      ...
      description:
        "Streamline your AI workflows and launch solutions at unprecedented speed with our scalable cloud systems.",
    ...
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
      <div className="px-8">
        ...
        <p className="text-sm lg:text-base max-w-2xl my-4 mx-auto text-neutral-500 text-center font-normal dark:text-neutral-300">
          Redefine your workflows and enhance creativity with our AI-powered tools. Transform the way you work, design, and innovate.
        </p>
      </div>
...
export const SkeletonFour = () => {
  return (
    <div className="h-60 md:h-60 flex flex-col items-center relative bg-transparent dark:bg-transparent mt-10 ml-auto">
